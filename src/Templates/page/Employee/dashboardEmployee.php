    ...
    <div class="max-w-7xl mx-auto p-6">
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-orange" id="pending-count">3</p>
                    </div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-green" id="processed-count">1</p>
                    </div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-lightblue">4.3/5</p>
                    </div>
            ...
            <div class="bg-white rounded-xl p-6 shadow-sm border">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-darkblue">12</p>
                    </div>
        ...
        <div class="mb-8">
            <h2 class="text-xl font-semibold mb-4 text-darkblue">
                Avis en attente de traitement (<span id="pending-title-count">3</span>)
            </h2>
            <div class="grid gap-4" id="pending-reviews">
                <!-- Les avis en attente seront injectés ici via PHP/JS -->
                <div class="review-card bg-white rounded-xl p-6 shadow-sm border" data-review-id="1">
                    <div class="flex items-start justify-between mb-4">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <h3 class="font-semibold text-lg">Marie Dubois</h3>
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-gray-800 leading-relaxed">Très bonne expérience, chauffeur ponctuel et véhicule propre. Service client réactif.</p>
                    </div>

                    <div class="flex space-x-3 pt-4 border-t">
                        <button onclick="handleReviewAction(1, 'accepted')" class="btn-transition flex items-center space-x-2 px-4 py-2 bg-green text-white rounded-lg font-medium">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                            </svg>
                            <span>Accepter</span>
                        ...
                        <button onclick="handleReviewAction(1, 'rejected')" class="btn-transition flex items-center space-x-2 px-4 py-2 bg-red-500 text-white rounded-lg font-medium">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <button onclick="handleReviewAction(1, 'contacted')" class="btn-transition flex items-center space-x-2 px-4 py-2 bg-orange text-white rounded-lg font-medium">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Ajouter d'autres avis similaires via PHP -->
            </div>
        </div>
