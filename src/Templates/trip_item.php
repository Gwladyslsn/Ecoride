...
<div class="trip w-full max-w-5xl bg-white rounded-2xl shadow-md hover:shadow-lg p-6 border border-gray-100 hover:border-green-custom transition-all duration-300 transform hover:-translate-y-1">
    <!-- Driver Info -->
